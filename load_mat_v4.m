function [data, name, T] = load_mat_v4(filename)
    % load_mat_v4: Read and extract data from a MAT-4 file.
    %
    %   [data, name, T] = load_mat_v4(FILENAME) reads a MAT-4 file specified by
    ...
    %
    %   Example:
    %   [data, name, T] = load_mat_v4('0284_001_004_ECG.mat');
    %
    %   Reference:
    ...
    try
        ...
        name = fread(fid, namelen, 'uint8=>char')';
